// Разовый скрипт: перевыпуск фича-поста "Подключиться к диалогу" ещё раз —
// CTA теперь общий (не привязан к конкретной фиче), плюс фиксы форматтера
// (пропущенные абзацы, вложенные tg-emoji теги).
